                            ...
                            <div class="row sn-slider">
                                <div class="col-md-4">
                                    <div class="sn-img">
                                        ...
                                        <div class="sn-title">
                                            <a href="">Raffi Ahmad Sekeluarga Nonton di Qatar</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="sn-img">
                                        ...
                                        <div class="sn-title">
                                            <a href="">Film The Wondering Moon</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="sn-img">
                                        ...
                                        <div class="sn-title">
                                            <a href="">Lay exo balik ke Korea. Exo Bakal comeback</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="tab-content">
                                        <div id="featured" class="container tab-pane active">
                                            <div class="tn-news">
                                                ...
                                                <div class="tn-title">
                                                    <a href="">Komentar kocak Kaesang saat tahu pernikahannya viral</a>
                                                </div>
                                            </div>
                                            <div class="tn-news">
                                                <div class="tn-img">
                                            ...
                                            <div class="tn-news">
                                                ...
                                                <div class="tn-title">
                                                    <a href="">Film The Wondering Moon Kisah Pertemuan dari Masa lalu</a>
                                                </div>
                                            </div>
                                            <div class="tn-news">
                                                <div class="tn-img">
                                                ...
                                                <div class="tn-title">
                                                    <a href="">Lay Exo balik ke Korea, Pertanda Exo Bakal Comeback</a>
                                                </div>
                                            </div>
                                            <div class="tn-news">
                                                <div class="tn-img">
